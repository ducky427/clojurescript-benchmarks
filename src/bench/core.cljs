...
(defn init!
  ...
  (simple-benchmark [[a b c] (take 3 (repeatedly #(rand-int 10)))] (-count (vec (array a b c))) 1000000)
  ...
  (simple-benchmark [m cljs.core.PersistentHashMap.EMPTY]
                    (loop [i 0 m (transient m)]
                      (if (> i 100000)
                        (persistent! m)
